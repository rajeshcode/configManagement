...
echo "start namenode"
sleep 1
ssh nox-srw-nn.vip.ebay.com "svc -u /service/namenode" 

echo "stop datanodes"
/usr/bin/ansible -i /var/lib/ansible/hadoop-ansible/hosts/nox slavenodes -m command -a "svc -u /service/datanode" -f 20 
sleep 1
